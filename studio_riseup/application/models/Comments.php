<?php
	class Comments
	{
		...
		{
			$this->db->query('SELECT Comments, Channel_Url,Post_Url,User_Url,C_Date  FROM comments WHERE Channel_Url = :Url ORDER BY C_Date DESC');
			...
			<a style="display: flex; width: 40%;" href="/feed/Article/'.$value->Post_Url.'/comments">
