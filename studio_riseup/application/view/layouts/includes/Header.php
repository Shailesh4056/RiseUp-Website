		...
		<div class="lit-header-main">
			<div class="lit-header-div">
				...
				<div class="lit-header-btn">
					...
					<a href="http://riseup.lit:81/feed/notification" target="_BLANK" class="h-btn">
					...
					<a href="http://riseup.lit:81/feed/CreateArticle" target="_BLANK" class="h-btn">
					...
					<div class="lit-header-account" style="<?php if(!isLoggedIn()){ echo 'display: none;'; } ?>" >
						...
						if(isLoggedIn()){
							$userdata = getdata();
						?>
						<img src="<?=RISEUP?>/images/<?=$userdata->Channel_Logo?>">
