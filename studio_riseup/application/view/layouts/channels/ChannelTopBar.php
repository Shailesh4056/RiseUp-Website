<div class="lit-channel-tb-main">
	...
	<div class="lit-channel-tb-btn-div">
		...
		<a <?php if($data['ChannelData']['File_Name'] == "ChannelArticleList.php"){ echo 'class="lit-channel-tb-btn lit-channel-tb-btb-click"'; }else{ echo 'class="lit-channel-tb-btn"'; } ?> href="<?=URLROOT?>/feed/channel/<?=$data['ChannelData']['Channel_Url']?>/articlelist" >
			<p>ArticleList</p>
		</a>
		...
		<form class="lit-channel-tb-search">
			...
			<input type="text" name="Channel_Search" placeholder="Search Here...">
		</form>
	</div>
</div>