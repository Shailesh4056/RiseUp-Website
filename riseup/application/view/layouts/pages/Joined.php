<div class="lit-library-main">
	<div class="lit-library-left">
		<div class="lit-library-contenar">
			<?php include "../application/view/layouts/joined/".$data['Joined_Data']['File_Name'];
			?>
		</div>
	</div>
	<div class="lit-library-right">
		<div class="lit-library-opsion-bar">
			...
			<a href="/feed/joined/" <?= ($data['Joined_Data']['File_Name'] == "joined.php") ? 'class="lit-library-opsion-bar-item 
			...
			<?=$data['Joined_Data']['Joined_Channel_item']?>
		</div>
	</div>
</div>