<div class="lit-library-main">
	...
	<div class="lit-library-right">
		<div class="lit-library-opsion-bar">
			...
			<a href="/feed/article/<?=$data['Article']['SB_Url']?>/read" <?= ($data['Article']['File_Name'] == "read.php") ? 'class="lit-library-opsion-bar-item lit-library-opsion-bar-item-click"' : 'class="lit-library-opsion-bar-item"' ?>>
				<p>Read article</p>
			</a>
